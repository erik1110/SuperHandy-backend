...
const initTasks = async () => {
    const userCase1 = await User.findOne({ email: 'user1@example.com' }).select(
        'lastName firstName phone',
    );
    const userCase2 = await User.findOne({ email: 'user2@example.com' }).select(
        'lastName firstName phone',
    );
    ...
    const userCase5 = await User.findOne({ email: 'weiyu@example.com' }).select(
        'lastName firstName phone',
    );
    const tasks = [
        {
            ...
            category: '寵物陪伴',
            description:
                '我家有黃金獵犬，但我這禮拜很忙，請幫我 2/20 早上 8 點來歌唱大樓找我，並帶他去附近公園陪他散步',
            salary: 300,
            exposurePlan: '黃金曝光',
        ...
        },
        {
            ...
            category: '文書處理',
            description:
                '我目前正在進行一份有關自然語言處理的畢業專題，需要一位有相關經驗的助理幫忙實驗和分析數據。',
            salary: 1300,
            exposurePlan: '限時黃金曝光',
            ...
            submmitInfo: {
                imgUrls: [
                    ...
                    'https://example.com/images/report4.jpg',
                ],
        ...
        },
        {
            ...
            category: '清潔外包',
            description:
                '需要一位勤快且細心的人來協助居家清潔，家裡有一些難以清潔的區域需要特別注意。',
            salary: 666,
            exposurePlan: '一般曝光',
            ...
            submmitInfo: {
                imgUrls: [
                    'https://example.com/images/report5.jpg',
                    'https://example.com/images/report6.jpg',
                    'https://example.com/images/report7.jpg',
                ],
        ...
        },
        {
            ...
            category: '其他內容',
            description:
                '我最近剛考到駕照，但還不太有經驗，需要一位有開車經驗的人來陪我練習開車，希望能有耐心且細心的教練。',
            salary: 567,
            exposurePlan: '限時曝光',
            ...
            submmitInfo: {
                imgUrls: [
                    'https://example.com/images/report8.jpg',
                    'https://example.com/images/report9.jpg',
                    'https://example.com/images/report10.jpg',
                ],
                comment: '學生學得很快，很有耐心。',
                submittedAt: new Date('2023-04-17T09:00:00'),
            },
        },
        {
            ...
            category: '電腦教學',
            description:
                '需要一位有經驗的人來教我如何使用 Notion 管理自己的筆記和待辦事項。',
            salary: 999,
            exposurePlan: '限時黃金曝光',
            ...
            submmitInfo: {
                imgUrls: [
                    'https://example.com/images/report11.jpg',
                    'https://example.com/images/report12.jpg',
                    'https://example.com/images/report13.jpg',
                ],
                comment: '',
                submittedAt: new Date('2023-04-17T09:00:00'),
            },
